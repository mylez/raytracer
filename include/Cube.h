...
// Todo - Must be converted to work with glm::vec3 rather than GLfloat arrays

// Todo - Cube could be better suited as an obj of 12 triangles.
...
public:
    ...
    // todo - implement Geometry::intersection for cube (if we keep a cube class)
